package com.ctbri.srhcore.parsedata.wanda;
...
//	public static String key_fun = "key=LBS189CN";
	...
	public static String filepath = CinemaC.Fetch_cinema_dir+"/resource/wandacsv/";
//	public static String url_fun = "http://qa.fun-guide.mobi:7005/";
//	public static String secret_fun = "ZhWAPN4CJmuadzJm";
//	public static String key_fun = "key=WP_YZBWPWAPI";
	
	
	public static String url_fun = "http://qa.fun-guide.mobi:7005/";
	public static String secret_fun = "9de35499658b6dd95643a98d92cc2c92";
	public static String key_fun = "key=test";
...
//		
//		
////		parseCinemaInCity("10");
////		parseCinemaInCity("514");
//		mergeFile();
...
//				
//				sb.append(movielist.get(i)).append(";");
//			}
//			U.log.debug(sb.toString());
...
//		String para = key_fun + "&cinemaId="+ cinemaid;
		...
		try {
			...
			for (int i = 0; i < len; i++) {
				...
				s[2] = temp.get("type").toString().replaceAll("\"", "“");//.replaceAll("\"", "\\\\\"");
				s[3] = temp.get("language").toString().replaceAll("\"", "“");//.replaceAll("\"", "\\\\\"");
